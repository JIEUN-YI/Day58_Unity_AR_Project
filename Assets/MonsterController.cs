        ...
        while (true)
        {
            ...
            monsterPos
                = new Vector3(center.x + Random.Range(-size.x * 0.4f, -size.x * 0.4f), // 바닥의 사이즈 안에서 랜덤으로 
                              center.y,
                              center.z + Random.Range(-size.x * 0.4f, -size.x * 0.4f));
            Debug.Log("몬스터의 랜덤 위치 출력");
            // 1. 바닥이 없는 경우에는 몬스터의 위치를 다시 지정
            ...
            {
                Debug.Log("바닥이 없어서 몬스터 위치 다시 출력");
                continue;
            }
            // 2. 바닥의 위치가 벽 뒤에 있는 경우 몬스터의 위치를 다시 지정
            ...
            {
                Debug.Log("벽으로 막혀서 몬스터 위치 다시 출력");
                continue;
            }
            break;
        }
        CreateMonster(monsterPos);
        Debug.Log("몬스터의 생성 완료");
